      ...
      <div className="bg-slate-50 py-24 sm:py-32 min-h-[80vh] flex items-center justify-center">
        <Card className="max-w-md mx-auto text-center border-emerald-100 shadow-lg">
          <CardHeader>
            ...
            <CardTitle className="text-2xl text-emerald-950">Application Received!</CardTitle>
            <CardDescription className="text-emerald-800/80 mt-2">
              Thank you for applying to B-HIVE. Our team will review your application and get back to you within 5-7 business days.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Button
    ...
    <div className="bg-slate-50 py-24 sm:py-32">
      <div className="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
        <div className="text-center mb-16">
          <h1 className="text-4xl font-bold tracking-tight text-slate-900 sm:text-5xl">Apply to B-HIVE</h1>
          <p className="mt-6 text-lg leading-8 text-slate-600">
            Take the first step towards building your venture. Fill out the form below to apply for our incubation programs.
          </p>
        </div>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
              <div className="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div className="space-y-2">
                  ...
                  <Input id="name" placeholder="Aditya Sethi" {...register("name")} />
                  {errors.name && <p className="text-sm text-red-500">{errors.name.message}</p>}
                </div>
                <div className="space-y-2">
                  <Label htmlFor="email">Email Address</Label>
                  <Input id="email" type="email" placeholder="aditya@example.com" {...register("email")} />
                ...
                <div className="space-y-2">
                  ...
                  <Input id="startupName" placeholder="TechCorp Inc." {...register("startupName")} />
                  {errors.startupName && <p className="text-sm text-red-500">{errors.startupName.message}</p>}
                </div>
                <div className="space-y-2">
                ...
                <div className="space-y-2">
                  ...
                  >
                    ...
                    <option value="Sustainability">Sustainable Infra & Clean Energy</option>
              ...
              <div className="space-y-2">
                <Label htmlFor="description">Short Description (Problem & Solution)</Label>
                <Textarea
                  id="description"
